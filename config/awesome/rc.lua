...
iconsmenu	= "/home/lockon/.config/awesome/icons/menu/"
...
-- Register widget #7F9F7F
vicious.register(netwidget, vicious.widgets.net, '<span color="#6699FF">${wlan0 up_kb}</span> <span color="#CC9393">${wlan0 down_kb}</span>', 3)


---------- wlan downstream
--netwidget = widget({type = "textbox"})
--vicious.register(netwidget, vicious.widges.net,round(args["{wlan0 down_kb}"], 0) .. "kb", 3)
